//
//  EZWechatManager.m
//  EZWechatManager_Example
//
//  Created by 陈诚 on 2020/11/26.
...
@interface EZWechatManager () <WXApiDelegate>
...
@implementation EZWechatManager
...
+ (instancetype)shareInstance {
    static EZWechatManager *weChatSDK;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        //单例创建最正确的姿势是allocWithZone而非alloc
        weChatSDK = [[EZWechatManager allocWithZone:nil] init];
    });
    return weChatSDK;
}
